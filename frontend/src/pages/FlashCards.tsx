      ...
      <div className="max-w-5xl mx-auto pt-10 pb-14">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(-1)}
              className="p-2 rounded-xl bg-zinc-950 border border-zinc-800 hover:bg-zinc-900"
              aria-label="Back"
            >
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {items.map((it) => (
            <div key={it.id} className="rounded-2xl bg-zinc-950 border border-zinc-800 p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  disabled={busy}
                  className="p-2 rounded-lg bg-zinc-950 border border-zinc-800 hover:bg-zinc-900 disabled:opacity-50"
                  aria-label="Delete"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="size-4 text-zinc-300" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="text-zinc-300 text-sm mt-2 whitespace-pre-wrap">{it.answer}</div>
            </div>
          ))}
        </div>
